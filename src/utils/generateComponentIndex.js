/**
 * @description parses the directory supplied as an argument and generates relevant imports / export statements dependencing on directory contents for a component
